...
OUTPUT_PATH = "/home/cjy/workspace/video/inference/deepsort13.mp4" 
...
# ★ 수정 1: ID 점프 방지를 위한 매핑 딕셔너리 및 카운터 추가
custom_id_map = {}
next_custom_id = 1
...
while True:
    ...
    # ★ 수정 2: 탐지된 객체가 없을 때도 tracker가 업데이트되도록 detections를 if문 밖으로 분리
    detections = []
