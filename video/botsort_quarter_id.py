...
OUTPUT_PATH = "/home/cjy/workspace/video/inference/botsort_quarter_id.mp4" 
...
while True:
    ...
    if all_boxes_list:
        ...
        # NMS를 통과한 결과만 모아서 supervision 형식으로 변환
        ...
        # 추적기에 데이터를 넣고 ID가 포함된 결과 받아오기
        tracked_detections = tracker.update_with_detections(detections)

        # 추적된 결과 순회하며 박스와 ID 그리기
        for i in range(len(tracked_detections.xyxy)):
            ...
            tracker_id = tracked_detections.tracker_id[i] # 고유 ID 획득
